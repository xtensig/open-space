    ...
    public sealed partial class ChemMasterWindow : FancyWindow
    {
        ...
        private ReagentButton MakeReagentButton(string text, ReagentId id, bool isBuffer)
        {
            ...
            reagentTransferButton.OnPressed += args
                => OnReagentButtonPressed?.Invoke(args, reagentTransferButton, _transferAmount, IsOutputTab);
        ...
        // Amount getters for selected reagents label
        ...
        private ReagentButton? CreateReagentTransferButton(ReagentId reagent, bool isBuffer, bool addReagentButtons)
        {
            ...
            // Use the appropriate toggle (buffer vs. pill) when determining the text
        ...
        // Calculate mixed color based on reagent percentages, similar to how beakers display color and update interface
        ...
        private void UpdateBottleContents(ChemMasterBoundUserInterfaceState state)
        {
            ...
            foreach (var reagent in bottleInfo.Reagents)
            {
                ...
                // Abbreviate name if it's longer than 17 characters
                if (name.Length > 17)
                {
        ...
        /// Abbreviates reagent name by shortening all words except the last one to 3 letters with a period.
