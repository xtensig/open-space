...
namespace Content.Client.ContextMenu.UI
{
    ...
    public sealed partial class ContextMenuPopup : Popup
    {
        ...
        private Action<Control>? _onChildRemovedHandler; // OpenSpace tweak
        public ContextMenuPopup (ContextMenuUIController uiController, ContextMenuElement? parentElement) : base()
        {
            ...
            _onChildRemovedHandler = ctrl => _uiController.OnRemoveElement(this, ctrl);
            MenuBody.OnChildRemoved += _onChildRemovedHandler;
            // OpenSpace tweak end.
        ...
        {
            // OpenSpace tweak start:
            if (_onChildRemovedHandler != null)
            {
                MenuBody.OnChildRemoved -= _onChildRemovedHandler;
                _onChildRemovedHandler = null;
            }
            // OpenSpace tweak end.
            ParentElement = null;
